...
class LLMQueryParser:
    ...
    def __init__(self, valid_categories, max_price=10_000_000, timeout_seconds=DEFAULT_TIMEOUT_SECONDS):
        ...
        self.account_id = os.getenv("CF_ACCOUNT_ID") or os.getenv("CLOUDFLARE_ACCOUNT_ID") or ""
        self.api_token = os.getenv("CF_API_TOKEN") or os.getenv("CLOUDFLARE_API_TOKEN") or ""
