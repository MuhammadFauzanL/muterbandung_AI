...
REVIEWED_DB_PATH = os.path.join("Dataset", "3_Curated", "DATABASE_WISATA_LABELED_V2_REVIEWED.csv")
LANDMARK_ALIAS_PATH = os.path.join("Dataset", "3_Curated", "landmark_aliases.csv")
...
class MuterBandungRecommender:
    ...
    def _query_facility_filters(self, query):
        ...
        if self._query_has_keyword(query, ["tidak ramai", "tidak terlalu ramai", "sepi", "anti ramai"]):
