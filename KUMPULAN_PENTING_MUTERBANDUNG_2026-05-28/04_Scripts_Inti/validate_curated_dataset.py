...
DEFAULT_JSON_OUTPUT = Path("Dataset/3_Curated/data_validation_results.json")
DEFAULT_MARKDOWN_OUTPUT = Path("Dokumentasi_Sistem/DATA_VALIDATION_REPORT_2026-05-25.md")
...
MEDIA_AUDIT_VALUES = {"accepted", "missing"}
TIME_FIELDS = [
    "jam_buka",
    "jam_tutup",
    "jam_buka_weekday",
...
class DatasetValidator:
    ...
    def validate_sentiment_contract(self):
        ...
        self.add_issue(
            ...
            "Available sentiment must use tfidf_linearsvc/run_nlp_pipeline_v2 provenance.",
            mask=available & (source.ne("tfidf_linearsvc") | version.ne("run_nlp_pipeline_v2")),
    ...
    def validate_media_contract(self):
        ...
        self.add_issue(
            ...
            "Rows with media_available=True must have media_audit_status=accepted.",
            mask=available & audit_status.ne("accepted"),
