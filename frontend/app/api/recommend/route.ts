...
// Baca dari environment variable, default ke localhost untuk dev
...
export async function POST(request: Request) {
  try {
    ...
    const res = await fetch(`${PYTHON_URL}/api/recommend`, {
      method: 'POST',
    ...
    console.error('BFF /api/recommend error:', error);
