  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errMsg = 'Login gagal. Silakan periksa kembali email dan kata sandi Anda.';
      ...
      const successTxt = 'Login berhasil! Mengarahkan ke halaman preferensi...';
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className="w-full rounded-[12px] border border-[#BFC8CE] bg-white pl-6 pr-12 py-[13px] text-[16px] text-slate-800 placeholder-[#6B7280] tracking-widest outline-none transition-all focus:border-[#00526E] focus:ring-1 focus:ring-[#00526E]"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="text-[14px]">
                <button type="button" onClick={() => showToast('Fitur pemulihan kata sandi akan segera hadir!', 'info')} className="font-medium text-[#00526E] hover:text-[#00415C] hover:underline">
                  Lupa kata sandi?
                </button>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`mt-6 w-full rounded-[12px] py-[16px] text-[14px] font-medium text-white transition-all shadow-[0_2px_4px_-2px_rgba(0,0,0,0.1),0_4px_6px_-1px_rgba(0,0,0,0.1)] ${
                isLoading 
                  ? 'bg-slate-400 cursor-not-allowed' 
                  : 'bg-[#00526E] hover:bg-[#00415C] active:scale-[0.99]'
              }`}
            >
              {isLoading ? 'Sedang Memproses...' : 'Masuk ke MuterBandung'}
            </button>
          </form>
        </div>
      </div>
