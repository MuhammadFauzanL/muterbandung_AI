...
VALIDATION_JSON_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/data_validation_results.json")
LOCAL_DATA_CANDIDATES_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/local_scrape_data_candidates.csv")
LOCAL_MEDIA_CANDIDATES_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/local_scrape_media_candidates.csv")
MANUAL_DATA_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/manual_data_fill_queue.csv")
MANUAL_MEDIA_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/manual_media_fill_queue.csv")
MANUAL_REALWORLD_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/manual_realworld_verification_queue.csv")

OUTPUT_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/targeted_data_completion_queue.csv")
OUTPUT_TOP_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/targeted_data_completion_top50.csv")
OUTPUT_REPORT_PATH = Path("Wisata_Workspace/03_Dokumentasi/TARGETED_DATA_COMPLETION_PLAN_2026-05-25.md")
