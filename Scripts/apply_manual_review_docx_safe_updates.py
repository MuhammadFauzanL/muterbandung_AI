...
DEFAULT_VALIDATION_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/manual_review_docx_validation_results.json")
DEFAULT_AUDIT_OUTPUT = Path("Wisata_Workspace/03_Dokumentasi/MANUAL_REVIEW_DOCX_SAFE_UPDATES_2026-05-26.md")
