...
DEFAULT_QUEUE_PATH = Path("Wisata_Workspace/01_Dataset/3_Curated/targeted_data_completion_top50.csv")
DEFAULT_JSON_OUTPUT = Path("Wisata_Workspace/01_Dataset/3_Curated/manual_review_docx_validation_results.json")
DEFAULT_MARKDOWN_OUTPUT = Path("Wisata_Workspace/03_Dokumentasi/MANUAL_REVIEW_DOCX_VALIDATION_2026-05-26.md")
